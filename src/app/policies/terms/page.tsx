    ...
    <>
      <section className="relative bg-midnight grain pt-32 pb-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <h1 className="mt-6 font-heading text-3xl font-semibold text-cream sm:text-4xl">Terms of Service</h1>
      ...
      <section className="bg-ivory py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-6 lg:px-10 space-y-10 text-sm leading-[1.7] text-slate">
          <div>
            <h2 className="font-heading text-xl font-medium text-charcoal">Agreement to Terms</h2>
          ...
          <div>
            <h2 className="font-heading text-xl font-medium text-charcoal">Products &amp; Pricing</h2>
          ...
          <div>
            <h2 className="font-heading text-xl font-medium text-charcoal">Intellectual Property</h2>
          ...
          <div>
            <h2 className="font-heading text-xl font-medium text-charcoal">Limitation of Liability</h2>
          ...
          <div>
            <h2 className="font-heading text-xl font-medium text-charcoal">Governing Law</h2>
          ...
          <div>
            ...
            <p className="mt-4">Questions? Email <a href="mailto:support@your-anwei.com" className="text-gold hover:text-gold-light cursor-pointer">support@your-anwei.com</a>.</p>
          </div>
        </div>
      </section>
    </>
